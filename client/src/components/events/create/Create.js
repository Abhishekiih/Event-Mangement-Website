...
const Create = () => {
    ...
    const [googleform, setGoogleFormLink] = useState('');
    const history = useHistory();

    const handleSubmit = (e) => {
        e.preventDefault();

        eventServices.create({ name, description, location, date, imageURL, googleform })
            .then(() => history.push('/'))
            .catch(err => {
                console.log(err);
            })
    ...
    const onChangeGoogleFormLink = (e) =>{
        ...
        <form className="Create" onSubmit={handleSubmit}>
            ...
            <div className="input">
                <input
                    ...
                    onChange={onChangeGoogleFormLink}
                    value={googleform}
                />
            </div>
